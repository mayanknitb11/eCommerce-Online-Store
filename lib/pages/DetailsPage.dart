...
import 'package:flutter_chat_demo/pages/OrderPage.dart';
...
class DetailContentMenu extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      child: Text(
        '12 years old Shop, we sold all Glosary item and also Delivery home free if your cart amount is minimum 500.',
        style: TextStyle(
            fontSize: 12.0,
